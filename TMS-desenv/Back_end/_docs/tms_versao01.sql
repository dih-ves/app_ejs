...
CREATE TABLE IF NOT EXISTS `tms`.`controleColaborador` (
  ...
  `ddsp` VARCHAR(5) NOT NULL,
  `holerite` VARCHAR(5) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tms`.`manutencaoVeiculo` (
  ...
  `garantia` FLOAT NULL,
  `outros` FLOAT NULL,
  `descricao_outros` VARCHAR(100) NULL,
  `veiculo_id` INT NOT NULL,
  `colaborador_id` INT NOT NULL,
  PRIMARY KEY (`id`),
...
-- Table `tms`.`peca`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tms`.`peca` (
  `id` INT NOT NULL,
  `nome` VARCHAR(30) NOT NULL,
  `valor` FLOAT NULL,
  PRIMARY KEY (`id`))
...
-- -----------------------------------------------------
-- Table `tms`.`pessoaFisica`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tms`.`pessoaFisica` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `cpf` VARCHAR(20) NOT NULL,
  `cliente_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_pessoaFisica_cliente1_idx` (`cliente_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `tms`.`enderecoCliente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tms`.`enderecoCliente` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  `cliente_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_enderecoCliente_cliente1_idx` (`cliente_id` ASC) VISIBLE,
  CONSTRAINT `fk_enderecoCliente_cliente1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabela registro de endereco de cliente';


-- -----------------------------------------------------
-- Table `tms`.`enderecoColaborador`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tms`.`enderecoColaborador` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `logradouro` VARCHAR(100) NOT NULL,
  `numero` INT NULL,
  `bairro` VARCHAR(45) NULL,
  ...
  `colaborador_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_enderecoColaborador_colaborador1_idx` (`colaborador_id` ASC) VISIBLE,
  CONSTRAINT `fk_enderecoColaborador_colaborador1`
    FOREIGN KEY (`colaborador_id`)
    REFERENCES `tms`.`colaborador` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `tms`.`documentosColaborador`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tms`.`documentosColaborador` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  `colaborador_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_documentosColaborador_colaborador1_idx` (`colaborador_id` ASC) VISIBLE,
  UNIQUE INDEX `ctps_UNIQUE` (`ctps` ASC) VISIBLE,
  UNIQUE INDEX `rg_UNIQUE` (`rg` ASC) VISIBLE,
  UNIQUE INDEX `cpf_UNIQUE` (`cpf` ASC) VISIBLE,
  UNIQUE INDEX `cnh_UNIQUE` (`cnh` ASC) VISIBLE,
  CONSTRAINT `fk_documentosColaborador_colaborador1`
    FOREIGN KEY (`colaborador_id`)
    REFERENCES `tms`.`colaborador` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `tms`.`enderecoFornecedor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tms`.`enderecoFornecedor` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  `fornecedor_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_enderecoFornecedor_fornecedor1_idx` (`fornecedor_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `tms`.`pessoaJuridica`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tms`.`pessoaJuridica` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  `cliente_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_pessoa_juridica_cliente1_idx` (`cliente_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `tms`.`manutencaoVeiculo_has_fornecedor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tms`.`manutencaoVeiculo_has_fornecedor` (
  `manutencaoVeiculo_id` INT NOT NULL,
  `fornecedor_id` INT NOT NULL,
  PRIMARY KEY (`manutencaoVeiculo_id`, `fornecedor_id`),
  INDEX `fk_manutencaoVeiculo_has_fornecedor_fornecedor1_idx` (`fornecedor_id` ASC) VISIBLE,
  INDEX `fk_manutencaoVeiculo_has_fornecedor_manutencaoVeiculo1_idx` (`manutencaoVeiculo_id` ASC) VISIBLE,
  CONSTRAINT `fk_manutencaoVeiculo_has_fornecedor_manutencaoVeiculo1`
    FOREIGN KEY (`manutencaoVeiculo_id`)
    REFERENCES `tms`.`manutencaoVeiculo` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_manutencaoVeiculo_has_fornecedor_fornecedor1`
    FOREIGN KEY (`fornecedor_id`)
    REFERENCES `tms`.`fornecedor` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `tms`.`manutencaoVeiculo_has_peca`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tms`.`manutencaoVeiculo_has_peca` (
  `manutencaoVeiculo_id` INT NOT NULL,
  `peca_id` INT NOT NULL,
  PRIMARY KEY (`manutencaoVeiculo_id`, `peca_id`),
  INDEX `fk_manutencaoVeiculo_has_peca_peca1_idx` (`peca_id` ASC) VISIBLE,
  INDEX `fk_manutencaoVeiculo_has_peca_manutencaoVeiculo1_idx` (`manutencaoVeiculo_id` ASC) VISIBLE,
  CONSTRAINT `fk_manutencaoVeiculo_has_peca_manutencaoVeiculo1`
    FOREIGN KEY (`manutencaoVeiculo_id`)
    REFERENCES `tms`.`manutencaoVeiculo` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_manutencaoVeiculo_has_peca_peca1`
    FOREIGN KEY (`peca_id`)
    REFERENCES `tms`.`peca` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
